...
training_gen = DataGenerator(batch_size=8, length=864)
validation_gen = DataGenerator(batch_size=8, length=864)
...
history = parallel_model.fit_generator(generator=training_gen, validation_data=validation_gen, epochs=100, max_queue_size=8, use_multiprocessing=True, verbose=1, workers=8)
exit()
