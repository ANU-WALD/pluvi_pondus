...
from data_loader import HimfieldsDataset

def Unet():
    concat_axis = 3
    ref_input = layers.Input(shape = (1024, 1024, 1))
    ...
    conv2 = layers.Conv2D(2*feats, (3, 3), strides=(2,2), activation='relu', padding='same')(bn2)
    ...
    conv3 = layers.Conv2D(4*feats, (3, 3), strides=(2,2), activation='relu', padding='same')(bn4)
    ...
    conv4 = layers.Conv2D(8*feats, (3, 3), strides=(2,2), activation='relu', padding='same')(bn6)
    ...
    conv5 = layers.Conv2D(16*feats, (3, 3), strides=(2,2), activation='relu', padding='same')(bn8)
    ...
    conv6 = layers.Conv2D(32*feats, (3, 3), strides=(2,2), activation='relu', padding='same')(bn10)
    ...
    model = tf.keras.models.Model(inputs=ref_input, outputs=conv10)
...
def fit(train_ds, test_ds, band, epochs):
  model = Unet()
  ...
  f = open("train_record_unet_mse_b{}_rainfields.out".format(band),"w+")
  ...
  f.close()
  model.save('unet_mse_b{}_rainfields.h5'.format(band))


train_fnames = ["/data/pluvi_pondus/HIM8_AU_2B/{}/HIM8_AU_20181101.nc",
                "/data/pluvi_pondus/HIM8_AU_2B/{}/HIM8_AU_20181102.nc",
                "/data/pluvi_pondus/HIM8_AU_2B/{}/HIM8_AU_20181103.nc",
                "/data/pluvi_pondus/HIM8_AU_2B/{}/HIM8_AU_20181104.nc",
                "/data/pluvi_pondus/HIM8_AU_2B/{}/HIM8_AU_20181105.nc",
                "/data/pluvi_pondus/HIM8_AU_2B/{}/HIM8_AU_20181106.nc",
                "/data/pluvi_pondus/HIM8_AU_2B/{}/HIM8_AU_20181107.nc"]

test_fnames = ["/data/pluvi_pondus/HIM8_AU_2B/{}/HIM8_AU_20181127.nc",
               "/data/pluvi_pondus/HIM8_AU_2B/{}/HIM8_AU_20181128.nc"]
...
#for band in [8,9,10,11,12,13,14,15]:

if __name__ == "__main__":
    band = int(sys.argv[1])
    EPOCHS = 15
    train_dataset = HimfieldsDataset(train_fnames, band, batch_size=4)
    test_dataset = HimfieldsDataset(test_fnames, band, batch_size=4)
    fit(train_dataset, test_dataset, band, EPOCHS)
