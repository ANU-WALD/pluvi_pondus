...
while [ "$DATE" != "$END" ]; do
	...
	cdo sellonlatbox,90.0,180.0,0.0,-60.0 /g/data/fj4/scratch/tmpz1.nc /g/data/fj4/scratch/eu_tmpz_$(date +%Y%m%d%H%M -d "$DATE").nc
...
cdo -b f32 mergetime /g/data/fj4/scratch/eu_tmpz_*.nc /g/data/fj4/scratch/AU_NATIVE_Z_ERA5.nc
cdo -b f32 mergetime /g/data/fj4/scratch/eu_tmpt_*.nc /g/data/fj4/scratch/AU_NATIVE_T_ERA5.nc
cdo -b f32 mergetime /g/data/fj4/scratch/eu_tmpr_*.nc /g/data/fj4/scratch/AU_NATIVE_RH_ERA5.nc
